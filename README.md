...
The report section lets you define where and how to store the checkpoints generated by your Committee Indexer. Currently, support is included for AWS S3, with a Data Availability (DA) layer option coming soon.
